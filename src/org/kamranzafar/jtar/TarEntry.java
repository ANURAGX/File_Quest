...
public class TarEntry {
    ...
    /**
     * Constructor to create an entry from an existing TarHeader object. This
     * method is useful to add new entries programmatically (e.g. for adding
     * files or directories that do not exist in the file system).
     * 
     * @param header
     */
