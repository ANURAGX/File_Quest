...
public class DeleteFiles{
	...
	public DeleteFiles(Context context,int width,final ArrayList<Item> list,String msg) {
		...
		mContext = context;
		len = list.size();
		final TextView textMsg = new TextView(mContext);
		
		final Builder builder = new MaterialDialog.Builder(context);
		builder.title(R.string.delete);
		builder.autoDismiss(false);
		builder.negativeText(R.string.dismiss);
		builder.positiveText(R.string.delete);
		builder.customView(textMsg, true);
					...
					public void handleMessage(Message msg){
						switch(msg.what){								
							...
							case 3:
								...
								build.content(R.string.delete_frm_ext_sd);
								build.title(R.string.delete_frm_ext_sd_title);
								build.positiveText(R.string.dismiss);
								build.autoDismiss(true);
								build.show();
								break;
		...
		textMsg.setText(R.string.delete_message);
		builder.show();
