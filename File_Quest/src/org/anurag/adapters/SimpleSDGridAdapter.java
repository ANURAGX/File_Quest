...
public class SimpleSDGridAdapter extends BaseAdapter{
	...
	public SimpleSDGridAdapter(Context ct , ArrayList<Item> objs) {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		hold h = new hold();
		item = list.get(arg0);
		View view = inf.inflate(R.layout.simple_grid_item_hd, arg2 , false);
		...
		h.lockimg.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(!list.get(img.getId()).isLocked()){
					...
					Constants.lock = img;
					new MasterPassword(ctx, list.get(img.getId()) ,prefs,
